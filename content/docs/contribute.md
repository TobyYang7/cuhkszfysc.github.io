...
- 飞跃手册其他帖子的[源代码](https://github.com/CUHKSZFYSC/CUHKSZFYSC/tree/master/docs)
...
::: warning
GitHub 的用户界面可能在本指南发布后有所变动，请以实际为准。如遇到问题，欢迎在[讨论区](https://github.com/CUHKSZFYSC/CUHKSZFYSC/discussions)提出。
:::

1. 访问我们的[仓库](https://github.com/CUHKSZFYSC/CUHKSZFYSC/tree/master/docs/)，并进入你的分享所属的文件夹，如 `grad-application/computer-science-and-engineering`。
2. 点击右上角 `Add file`
...
这一节假定你已经安装了 git 和相关的编辑器等工具，并且对 git 的使用有最基本的了解。如果你对 git 不甚了解，欢迎你联系维护者寻求帮助，在[讨论区](https://github.com/CUHKSZFYSC/CUHKSZFYSC/discussions)提问，或者参考 [git 文档](https://git-scm.com/doc)进行学习。

1. [Fork](https://github.com/CUHKSZFYSC/CUHKSZFYSC/fork) 我们的仓库。
2. `clone` 你的 fork 到本地。
...
- 撰写经验分享帖子
- 在仓库中[创建新 Issue](https://github.com/CUHKSZFYSC/CUHKSZFYSC/issues/new)，并将你的帖子作为附件上传。
